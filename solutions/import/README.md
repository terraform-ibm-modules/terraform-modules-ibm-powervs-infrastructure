...
| Name | Type |
|------|------|
| [ibm_is_network_acl.management_acls_ds](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.70.1/docs/data-sources/is_network_acl) | data source |
| [ibm_is_subnet.management_subnets_ds](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.70.1/docs/data-sources/is_subnet) | data source |
| [ibm_tg_gateway.tgw_ds](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.70.1/docs/data-sources/tg_gateway) | data source |
...
| <a name="input_powervs_workspace_guid"></a> [powervs\_workspace\_guid](#input\_powervs\_workspace\_guid) | GUID of the existing PowerVS workspace. | `string` | n/a | yes |
